...
public:
	...
	// parameters
	PROP_PARAM(Material, allowed_ray_material);
	PROP_PARAM(Material, forbidden_ray_material);
	...
	PROP_PARAM(Mask, interaction_collision_mask, 0);
	PROP_ARRAY(Node, left_controller_colliders);
	PROP_ARRAY(Node, right_controller_colliders);
	PROP_PARAM(Switch, teleport_controller, 0, "LEFT,RIGHT,LEFT AND RIGHT");
	PROP_PARAM(Switch, teleport_button, 0, "STICK X,STICK Y,TRIGGER,GRIP,XA,YB,MENU");
	PROP_PARAM(Switch, grab_button, 0, "STICK X,STICK Y,TRIGGER,GRIP,XA,YB,MENU");
	PROP_PARAM(Switch, use_button, 0, "STICK X,STICK Y,TRIGGER,GRIP,XA,YB,MENU");
	PROP_PARAM(Switch, turn_controller, 0, "LEFT,RIGHT");
	PROP_PARAM(Switch, turn_axis, 0, "STICK X,STICK Y");
	PROP_PARAM(Switch, move_controller, 0, "LEFT,RIGHT");
	PROP_PARAM(Switch, move_axis_x, 0, "STICK X,STICK Y");
	PROP_PARAM(Switch, move_axis_y, 0, "STICK X,STICK Y");
...
protected:
	...
	Unigine::Vector<Unigine::ShapePtr> controller_colliders[CONTROLLER_COUNT];
	...
	Unigine::Vector<Unigine::Vector<VRInteractable*>> selected_components;
